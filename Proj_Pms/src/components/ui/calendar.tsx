  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_month: "relative inline-flex items-center px-3 py-2 text-sm font-medium",
        dropdown_year: "relative inline-flex items-center px-3 py-2 text-sm font-medium",
